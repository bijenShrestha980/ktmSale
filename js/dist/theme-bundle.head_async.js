        ...
        var r = t.documentElement,
          ...
          S = (function () {
            var o,
              ...
              I = function (e) {
                return (
                  null == L && (L = "hidden" == A(t.body, "visibility")),
                  L ||
              ...
              q = function (e, n) {
                ...
                for (
                  T -= n, B += n, W -= n, P += n;
                  o && (a = a.offsetParent) && a != t.body && a != r;
              ...
              U = function () {
                var e,
                  ...
                  g,
                  b = n.elements;
                if ((m = i.loadMode) && k < 8 && (e = b.length)) {
                  for (a = 0, H++; a < e; a++)
                    if (b[a] && !b[a]._lazyRace)
                      if (!j || (n.prematureUnveil && n.prematureUnveil(b[a])))
                        Y(b[a]);
                      else if (
                        (((v = b[a][l]("data-expand")) && (f = 1 * v)) ||
                          (f = D),
                        z ||
                          ((z =
                            !i.expand || i.expand < 1
              ...
              X = w(function (e, t, n, r, a) {
                var o, s, u, d, m, v;
                (m = C(e, "lazybeforeunveil", t)).defaultPrevented ||
                  (r &&
                    (n ? h(e, i.autosizesClass) : e.setAttribute("sizes", r)),
                  (s = e[l](i.srcsetAttr)),
                  (o = e[l](i.srcAttr)),
                  a && (d = (u = e.parentNode) && y.test(u.nodeName || "")),
                  (v = t.firesLoad || ("src" in e && (s || o || d))),
                  (m = { target: e }),
                  h(e, i.loadingClass),
                  v && (clearTimeout(f), (f = c($, 2500)), b(e, Q, !0)),
                  d && p.call(u.getElementsByTagName("source"), V),
                  s
              ...
              ee = function () {
                3 == i.loadMode && (i.loadMode = 2), Z();
              },
              te = function () {
                if (!d) {
                  if (a.now() - v < 999) return void c(te, 999);
                  (d = !0), (i.loadMode = 3), G(), u("scroll", ee, !0);
                }
              };
            return {
              _: function () {
                (v = a.now()),
                  ...
                  /d$|^c/.test(t.readyState)
                    ? te()
                    : (u("load", te), t[s]("DOMContentLoaded", G), c(te, 2e4)),
                  n.elements.length ? (U(), M._lsFlush()) : G();
              },
              checkElems: G,
              unveil: Y,
              _aLSL: ee,
          ...
          O = (function () {
            var e,
              ...
              r = function (e, t, i) {
                ...
                a &&
                  ((i = E(e, a, i)),
                  (r = C(e, "lazybeforesizes", { width: i, dataAttr: !!t }))
                    .defaultPrevented ||
                    ((i = r.detail.width) &&
                      i !== e._lazysizesWidth &&
                      n(e, a, r, i)));
          ...
          T = function () {
            !T.i && t.getElementsByClassName && ((T.i = !0), O._(), S._());
          };
        return (
          c(function () {
            i.init && T();
